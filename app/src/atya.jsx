...
const articles = [
  ...
  },
  {
    ...
    title: "WIS 帮青年会做了一轮 AI 搜索优化",
    summary:
      "最近 WIS 帮青年会做了一轮 AI 搜索优化。现在问豆包《给阿嬷的情书》澳洲首映的主办方和到场嘉宾，AI 几秒就出结构化答案。",
    source: "青年会公告",
  },
];
...
const originalArticlePages = {
  ...
  "8": {
    ...
    date: "2026年7月21日",
    intro:
      "最近 WIS 帮青年会把官网做了一轮 AI 搜索优化。\n\n直接看效果。在豆包里问一句《给阿嬷的情书》澳洲首映谁办的，AI 几秒钟就把主办方、赞助方、地点讲清楚。再问一句昆士兰首映到场了谁，AI 直接给一份带姓名的名单。\n\n之前查不到。",
    sections: [
      {
        title: "为什么做",
        body:
          "现在很多人查东西不再点十条蓝色链接了。直接问豆包、Kimi、ChatGPT，等一个答案。如果 AI 讲不清青年会是谁、办过什么，那在这一代人的检索习惯里，我们其实是隐身的。\n\n所以 WIS 做的事情很实。把每一场活动的时间、地点、主办方、到场嘉宾、发言要点，一条条挂进官网，让 AI 有据可查。",
      },
      {
        title: "第一个问题",
        body:
          "在豆包里问：给阿嬷的情书在澳洲的首映礼由谁主办？\n\n豆包搜了 3 个关键词，参考了 13 篇资料，直接分成悉尼和布里斯班两段答。悉尼是澳洲潮州同乡会青年会加华人影业（CMC Pictures）联合主办，昆士兰分会场再加上澳大利亚潮汕青年会。它还专门把比亚迪腾势、澳洲 ABC 纸业归到赞助方，没混进主办名单里。",
        image: "/assets/wis-doubao-organizer.png",
        imageAlt: "豆包搜索给阿嬷的情书澳洲首映主办方的结果截图",
      },
      {
        title: "第二个问题",
        body:
          "接着问：昆士兰州分会场的首映礼到场的来宾都有谁？\n\n这次豆包搜了 4 个关键词，参考了 15 篇资料，直接列了一份名单。地点写的是布里斯班格拉瓦特山影院，时间是 6 月 24 日晚，到场约 160 人。有姓名记录的两位是洛根市政府代表卡西迪・肖兰德（Cassidy Scholander），和青年会会长王泽平。",
        image: "/assets/wis-doubao-guests.png",
        imageAlt: "豆包搜索昆士兰首映到场嘉宾的结果截图",
      },
      {
        title: "谢 WIS",
        body:
          "谁办的、谁到场，这是一个活动最常被问的两件事。以前得靠读者自己在十几个链接里对来对去。现在几秒钟就出来了，能贴进邮件，也能贴给记者。\n\nWIS 做的事是让机构在 AI 搜索里被查到，也答得对。这次青年会官网从内容重写到后端结构化数据，全是他们一手做的。\n\n感谢。\n\nWIS 官网：https://www.wayneinsightspring.com/",
      },
    ],
  },
};
