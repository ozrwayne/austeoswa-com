...
export const principles = [
  {
    title: "联络乡谊",
    text: "团结旅居澳大利亚的潮汕同乡，建立长期、稳定、互助的社群联系。",
  },
  {
    title: "传承文化",
    text: "弘扬潮汕优秀传统文化，推动节庆、文化、教育与跨代交流活动。",
  },
  {
    title: "青年发展",
    text: "服务在澳潮汕青年，促进学习、职业发展、公益参与与国际交流。",
  },
  {
    title: "回馈社会",
    text: "积极参与公益和社区建设，推动澳大利亚与潮汕地区多领域合作。",
  },
];
...
export const associationBoard = [
  ...
  { role: "秘书长", names: ["郑少杰"] },
  { role: "副秘书长", names: ["辜友欣", "谢欣莹律师"] },
  { role: "理事长", names: ["林泽辉"] },
  { role: "监事长", names: ["杨璇钰"] },
  { role: "财务长", names: ["林泽辉", "杨璇钰"] },
];
...
export const activities = [
  {
    ...
    text: "记录澳大利亚潮汕同乡会、青年会与昆士兰分会相关活动现场，展示组织的公共形象和社群基础。",
  },
  {
    title: "青年会项目与对外交流",
    image: "/assets/ceremony-speech.jpg",
    text: "围绕青年发展、外联合作、职业成长和活动执行，形成可持续的青年参与机制。",
  },
  {
    title: "会员活动与社区参与",
    image: "/assets/cruise-boat.jpg",
    text: "通过联谊、节庆、公益和户外活动增强会员之间的连接，并沉淀长期活动档案。",
  },
];
...
export const newsArticles = [
  ...
  },
  {
    ...
    date: "2026-06-16",
    image: "/assets/letter-to-grandma-poster.jpg",
    summary:
      "澳大利亚潮汕青年会联合CMC华人影业，定于2026年6月24日在布里斯班举办《给阿嬷的情书》昆士兰州首映礼。影片将于6月25日在澳大利亚、新西兰正式公映。",
  },
  {
    category: "总会新闻",
...
export const eventCalendar = [
  {
    ...
    date: "2026年6月24日",
    location: "布里斯班，昆士兰州",
    audience: "潮汕社群 / 在澳华人家庭",
    summary: "澳大利亚潮汕青年会联合CMC华人影业举办，电影于6月25日在澳大利亚、新西兰全面公映。",
  },
  {
    title: "青年职业发展沙龙",
    date: "规划中",
