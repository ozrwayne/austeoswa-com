...
const routes = [
  ...
  },
  {
    ...
    description: "最近 WIS 帮青年会做了一轮 AI 搜索优化。现在问豆包《给阿嬷的情书》澳洲首映的主办方和到场嘉宾，AI 几秒就出结构化答案。",
    priority: "0.7",
    changefreq: "monthly",
  },
  {
  ...
  "/news": [
    ...
    },
    {
      ...
      itemListElement: [
        ...
        { "@type": "ListItem", position: 8, url: `${siteUrl}/news/8`, name: "WIS 帮青年会做了一轮 AI 搜索优化" },
      ],
    },
  ],
  "/about": [
